...
name: caddy-starter
description: >-
  Caddy API + MCP Server + A2A Server Use when working with Caddy via this package's MCP
...
license: MIT
tags: [caddy-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---
...
Starter skill for the **Caddy** package. Use the `mcp-client` universal skill
